 ...
 * 2019-10-24T09:06:24.876+05:30
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "IIBFinacleIntegration", 
                  wsdlLocation = "file:/C:/Users/admin/git/SB_OC_Transfer/src/main/resources/wsdl/IIBFinacleIntegration.wsdl",
...
public class IIBFinacleIntegration_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/admin/git/SB_OC_Transfer/src/main/resources/wsdl/IIBFinacleIntegration.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IIBFinacleIntegration_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/admin/git/SB_OC_Transfer/src/main/resources/wsdl/IIBFinacleIntegration.wsdl");
        }
        WSDL_LOCATION = url;
    }
