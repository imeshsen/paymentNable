...
public class StopChequeFault extends Exception {
    ...
    public StopChequeFault(String message, lk.sampath.oc.Transfers.integration.finacleIntegration.ExecutionExceptionType executionException) {
        super(message);
        this.executionException = executionException;
    }

    public StopChequeFault(String message, lk.sampath.oc.Transfers.integration.finacleIntegration.ExecutionExceptionType executionException, Throwable cause) {
        super(message, cause);
        this.executionException = executionException;
    }
